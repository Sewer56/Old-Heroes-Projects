...
namespace SHLayoutEditor
{
	public partial class ThemeDialog
	{
		...
		protected virtual void Build()
		{
			...
			// Widget SHLayoutEditor.ThemeDialog
			this.Name = "SHLayoutEditor.ThemeDialog";
			this.Title = "ThemeDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child SHLayoutEditor.ThemeDialog.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child SHLayoutEditor.ThemeDialog.ActionArea
