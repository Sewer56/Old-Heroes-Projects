...
namespace HeroesGHConfigTool
{
    class Fonts
    {
        ...
        public Font RobotoSpecialTextTinyUI2;
        public Font RobotoComboBoxSmallTinyUI;
        public Font RobotoTextBoxSmallTinyUI;
        public Font RobotoTextBoxSmallerTinyUI;
        public Font RobotoNumericUpDownTinyUI;
        public Font TextMini;
        ...
        {                                                                                                           // ---------------------------------------------------------------------------------
            try
            {
                Roboto.AddFontFile(AppDomain.CurrentDomain.BaseDirectory + @"Greatest-Hits\Fonts\RobotoCondensed-Regular.ttf");   // Load the Roboto Condensed font into the PrivateFontCollection.
                Roboto.AddFontFile(AppDomain.CurrentDomain.BaseDirectory + @"Greatest-Hits\Fonts\RobotoCondensed-Italic.ttf");    // Load the Roboto Condensed Italic font into the PrivateFontCollection.
                Roboto.AddFontFile(AppDomain.CurrentDomain.BaseDirectory + @"Greatest-Hits\Fonts\RobotoCondensed-Bold.ttf");      // Load the Roboto Condensed Bold font into the PrivateFontCollection.
                Roboto.AddFontFile(AppDomain.CurrentDomain.BaseDirectory + @"Greatest-Hits\Fonts\RobotoCondensed-BoldItalic.ttf");// Load the Roboto Condensed Bold Italic font into the PrivateFontCollection.

                Roboto.AddFontFile(AppDomain.CurrentDomain.BaseDirectory + @"Greatest-Hits\Fonts\Roboto-Regular.ttf");            // Load the Roboto font into the PrivateFontCollection.
                Roboto.AddFontFile(AppDomain.CurrentDomain.BaseDirectory + @"Greatest-Hits\Fonts\Roboto-Bold.ttf");               // Load the Roboto Bold font into the PrivateFontCollection.
                Roboto.AddFontFile(AppDomain.CurrentDomain.BaseDirectory + @"Greatest-Hits\Fonts\Roboto-Light.ttf");              // Load the Roboto light font into the PrivateFontCollection.
                Roboto.AddFontFile(AppDomain.CurrentDomain.BaseDirectory + @"Greatest-Hits\Fonts\Roboto-Thin.ttf");               // Load the Roboto thin font into the PrivateFontCollection.
                ...
                RobotoComboBoxSmallTinyUI = new Font(Roboto.Families[2], 9.75F);
                RobotoTextBoxSmallTinyUI = new Font(Roboto.Families[2], 14.25F);
                RobotoTextBoxSmallerTinyUI = new Font(Roboto.Families[2], 12F);
                RobotoSpecialTextTinyUI2 = new Font(Roboto.Families[2], 14.25F);
                RobotoNumericUpDownTinyUI = new Font(Roboto.Families[1], 9.75F);
                TextMini = new Font(Roboto.Families[1], 9.75F);
            }
            catch (Exception)
            {
